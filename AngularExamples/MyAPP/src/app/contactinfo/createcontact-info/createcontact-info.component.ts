...
import {ContactControllerService} from "../services/contactcontroller.service";
...
export class CreatecontactInfoComponent implements OnInit {
  ...
  constructor(public apiService:ContactControllerService) { 
  ...
  onSubmit(data:any)
  {
    ...
    this.apiService.createNewContact(data).subscribe(response=>console.log('success'));
